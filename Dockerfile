...
#
# Single image serving BOTH transports of the vgi-etf-invesco worker:
...
ARG SOURCE_URL=https://github.com/Query-farm/vgi-etf-invesco

LABEL org.opencontainers.image.title="vgi-etf-invesco" \
      org.opencontainers.image.description="Invesco US ETF data as a VGI worker for DuckDB/SQL (stdio + HTTP)" \
